...
class ProvidersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->success($providers, 'Se dio de alta el proveedor.');
            ...
            log::debug($response);
            return response()->error('Error al crear proveedor.', $response, Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    ...
    { 
        ...
        try {
            ...
            return response()->success($providers, 'Se actualizó el proveedor.');
        } catch (\Exception $exception) {
            DB::rollBack();
            $response = [
                "file"    => $exception->getFile(),
            ...
            log::debug($response);
            return response()->error('Error al actualizar proveedor.', $response, Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            return response()->success($provider, 'Se eliminó el proveedor.');
        } catch (\Exception $exception) {
            DB::rollBack();
            $response = [
                "file"    => $exception->getFile(),
            ...
            log::debug($response);
            return response()->error('Error al eliminar proveedor.', $response, Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
    /**
    ...
    public function change_status(string $id)
    {
        ...
        try {
            ...
            return response()->success($provider, 'Se cambio de estatus el proveedor.');
        } catch (\Exception $exception) {
            DB::rollBack();
            $response = [
                "file"    => $exception->getFile(),
            ...
            log::debug($response);
            return response()->error('Error al cambiar de estatus proveedor.', $response, Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    }
}
