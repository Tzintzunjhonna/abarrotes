                            ...
                            <form class="needs-validation" @submit.prevent="onSubmit">
                                <div class="row">
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <div class="input-errors" v-for="error of f$.address.$errors" :key="error.$uid">
                                            <div class="text-danger">{{ error.$message }}</div>
                                        </div>
                                    </div>
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <input v-model="form.phone" type="number" class="form-control" id="phone"
                                            ...
                                            maxlength="10">
                                        <div class="input-errors" v-for="error of f$.phone.$errors" :key="error.$uid">
                                            <div class="text-danger">{{ error.$message }}</div>
                                        </div>
                                    </div>
                                    <div class="mb-2 col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <Multiselect v-model="form.regimen_fiscal_id" track-by="nombre" label="nombre"
                                            placeholder="Selecciona un regimen fiscal" :show-labels="false"
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <Multiselect v-model="form.metodo_pago_id" track-by="nombre" label="nombre"
                                            ...
                                            deselectLabel=" " :block-keys="['Tab', 'Enter']" :options="cat_metodo_pago"
                                            :searchable="true" :allow-empty="true" :showNoOptions="false">
                                            <template v-slot:noResult>
                                                <span>Opción no encontrada</span>
                                            </template>
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <Multiselect v-model="form.forma_pago_id" track-by="nombre" label="nombre"
                                            ...
                                            deselectLabel=" " :block-keys="['Tab', 'Enter']" :options="cat_forma_pago"
                                            :searchable="true" :allow-empty="true" :showNoOptions="false">
                                            <template v-slot:noResult>
                                                <span>Opción no encontrada</span>
                                            </template>
                                    ...
                                    <div class="mb-2 col-md-6">
                                        <label for="tipo_exportacion_id" class="form-label">Tipo de
                                            exportación</label>
                                        <Multiselect v-model="form.tipo_exportacion_id" track-by="nombre" label="nombre"
                                            placeholder="Selecciona un tipo de exportación" :show-labels="false"
                                            deselectLabel=" " :block-keys="['Tab', 'Enter']"
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <input v-model="form.zip_code" type="number" class="form-control" id="zip_code"
                                            placeholder="Código postal (Timbrado)" step="1"
                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                            maxlength="5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <input v-model="form.codigo_postal_id" type="text" class="form-control"
                                            id="codigo_postal_id" placeholder="Código postal" step="1" maxlength="6">
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <Multiselect v-model="form.estado_id" track-by="nombre" label="nombre"
                                            placeholder="Selecciona un estado" :show-labels="false" deselectLabel=" "
                                            :block-keys="['Tab', 'Enter']" :options="cat_estado" :searchable="true"
                                            :allow-empty="true" :showNoOptions="false">
                                            <template v-slot:noResult>
                                                <span>Opción no encontrada</span>
                                            </template>
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <Multiselect v-model="form.municipio_id" track-by="nombre" label="nombre"
                                            placeholder="Selecciona un municipio" :show-labels="false" deselectLabel=" "
                                            :block-keys="['Tab', 'Enter']" :options="cat_municipio" :searchable="true"
                                            :allow-empty="true" :showNoOptions="false">
                                            <template v-slot:noResult>
                                                <span>Opción no encontrada</span>
                                            </template>
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <Multiselect v-model="form.localidad_id" track-by="nombre" label="nombre"
                                            placeholder="Selecciona un localidad" :show-labels="false" deselectLabel=" "
                                            :block-keys="['Tab', 'Enter']" :options="cat_localidad" :searchable="true"
                                            :allow-empty="true" :showNoOptions="false">
                                            <template v-slot:noResult>
                                                <span>Opción no encontrada</span>
                                            </template>
                                    ...
                                    <div class="mb-2 col-md-6">
                                        ...
                                        <input v-model="form.number" type="number" class="form-control" id="number"
