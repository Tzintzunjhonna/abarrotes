...
const pageNowName = ref('Lista de permisos')
const prevPageUrl = ref('')


// TABLAS --------------------------
let endpoint = ref(`v1/app-permissions/collection`)

const getList = ref([])
const tableHeaders = ['ID', 'Nombre', 'Permiso', 'Fecha de registro', 'Opciones'];
const tableTitle = ref('Lista de permisos')
...
function onEdit(data) {
    ...
    ids = btoa(ids);
    router.visit(`/admin/permisos/${ids}/editar`);
}
...
function onAdd(data) {
    router.visit(`/admin/permisos/nuevo`);
}

function onPermissions(data) {
    let ids = data.id.toString();
    ids = btoa(ids);
    router.visit(`/admin/permisos/${ids}/asignar`);
}
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <table-pagination :headers="tableHeaders" :tbody="tbody" :options="true" :actions="actions"
                        ...
                        :labelBtnNew="'Nuevo permiso'" :showBtnNew="true" :reload="reloadPage" @reload="reload"/>
                </div>
            </div>
        </div>
    </div>
